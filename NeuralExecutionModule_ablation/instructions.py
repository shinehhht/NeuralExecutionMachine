...
class InstructionPool(nn.Module):
    def __init__(self,config):
        ...
        self.logic_not = LogicOperator(config,'not')
    ...
    def forward(self, op1, op2):
        ...
        logic_not = self.logic_not(op1,op2)
        ...
        #outs = [add_dist, sub_dist,logic_and,logic_or,logic_not,sin,cmp]
        
        #delete logic_or
        #outs = [add_dist, sub_dist,logic_and,logic_not,sin,cmp]
        
        # delete sin
        outs = [add_dist, sub_dist, logic_and, logic_or,logic_not,cmp]
        
        # delete cmp
        #outs = [add_dist, sub_dist,logic_and,logic_or,logic_not,sin]
        
        # delete add
        #outs = [sub_dist,logic_and,logic_or,logic_not,sin,cmp]
        
        # delete and
        #outs = [add_dist, sub_dist,logic_or,logic_not,sin,cmp]
