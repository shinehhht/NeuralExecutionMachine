from library import make_program_demo,make_program_demo_jump
...
program = make_program_demo_jump(n_regs,n_vals)
...
print(state.R.read(torch.tensor([[ 0.,0.,0.,1.]])).argmax(1).item())